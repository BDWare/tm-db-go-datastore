...
// https://github.com/tendermint/tm-db/blob/3157a928986298875ca48e6d5f77132a32dfb1f0/backend_test.go
package db
...
func cleanupDBDir(db db.DB, dir string) {
	db.Close()
	os.RemoveAll(dir)
}

// https://github.com/tendermint/tm-db/blob/3157a928986298875ca48e6d5f77132a32dfb1f0/backend_test.go#L36
func testBackendGetSetDelete(t *testing.T) {
	// Default
	db, dir, err := newTempDB("test_backend")
...
func testDBIterator(t *testing.T) {
	...
	db2, dir, err := newTempDB("tm-db-test")
	require.NoError(t, err)
	defer cleanupDBDir(db, dir)
...
// https://github.com/tendermint/tm-db/blob/3157a928986298875ca48e6d5f77132a32dfb1f0/backend_test.go#L321
...
// https://github.com/tendermint/tm-db/blob/3157a928986298875ca48e6d5f77132a32dfb1f0/backend_test.go#L411
